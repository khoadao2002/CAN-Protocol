  ...
  while (1)
  {
	  if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0))
	  {
		  if(!count)
		  {
			  ...
			  txMessage.frame.data0 = 'H';
			  txMessage.frame.data1 = 'e';
			  txMessage.frame.data2 = 'l';
			  txMessage.frame.data3 = 'l';
			  txMessage.frame.data4 = 'o';
			  txMessage.frame.data5 = '!';
			  txMessage.frame.data6 = '\r';
